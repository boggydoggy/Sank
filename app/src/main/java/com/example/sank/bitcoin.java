...
public class bitcoin extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        int checkEz = pref.getInt("bitEz",0); //쉬운 문제 정답 확인
        int checkHz = pref.getInt("bitHz", 0); //어려운 문제 정답 확인

        Button Ez = (Button) findViewById(R.id.bitEQ);
        Button Hz = (Button) findViewById(R.id.bitHQ);
    ...
    public void popEz(View v){
        Intent intent = new Intent(this, bitEz.class);
        startActivity(intent);
        finish();
    }
    public void popHz(View v){
        Intent intent = new Intent(this, bitHz.class);
        startActivity(intent);
        finish();
    }
